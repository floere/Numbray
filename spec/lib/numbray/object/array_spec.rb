...
describe Numbray::Object::Array do

  describe "memory_efficient_intersect" do
    it "should intersect empty arrays correctly" do
      arys = [[3,4], [1,2,3], []]

      Numbray::Object::Array.memory_efficient_intersect(arys).should == []
    end
    ...
    it "should intersect correctly" do
      ...
      Numbray::Object::Array.memory_efficient_intersect(arys).should == [3]
    end
    it "should intersect correctly again" do
      arys = [[1,2,3,5,6,7], [3,4,5,6,7,8,9], [3,4,5,6,7]]
      Numbray::Object::Array.memory_efficient_intersect(arys).should == [3,5,6,7]
    end
    ...
    it "should handle random arrays" do
      ...
      Numbray::Object::Array.memory_efficient_intersect(arys).should == arys.inject(arys.shift.dup) { |total, ary| total & arys }
    end
    it "should be optimal for 2 small arrays of 50/10_000" do
      ...
      # Brute force.
      #
      performance_of { Numbray::Object::Array.memory_efficient_intersect(arys) }.should < 0.001
    end
    it "should be optimal for 2 small arrays of 50/10_000" do
      arys = [(1..50).to_a, (10_000..20_000).to_a << 7]
  ...
  describe "memory_efficient_intersect with symbols" do
    ...
    it "should intersect correctly" do
      ...
      Numbray::Object::Array.memory_efficient_intersect(arys).should == [:c]
    end
    it "should intersect many arrays" do
      arys = [[:c,:d,:e,:f,:g], [:a,:b,:c,:e,:f,:g], [:c,:d,:e,:f,:g,:h,:i], [:a,:b,:c,:d,:e,:f,:g,:h,:i,:j], [:b,:c,:e,:f,:g,:s], [:a,:b,:c,:d,:e,:f,:g,:h,:i,:j], [:b,:c,:e,:f,:g,:s]]

      Numbray::Object::Array.memory_efficient_intersect(arys).should == [:c,:e,:f,:g]
    end
    it "should be optimal for 2 small arrays of 50/10_000" do
  ...
  describe "memory_efficient_intersect with strings" do
    ...
    it "should be optimal for 2 small arrays of 50/10_000" do
      ...
      #
      performance_of { Numbray::Object::Array.memory_efficient_intersect(arys) }.should < 0.0015
    end
